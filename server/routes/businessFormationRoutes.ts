...
// Corporate Tools - These routes currently return "not configured" responses
// They can be expanded in the future when Corporate Tools integration is added
// ----------------------
...
router.get('/corporate-tools/status', (_req: Request, res: Response) => {
  ...
  res.json({ 
    ...
    message: 'Integration not yet available. Please check back later.'
  });
});
