            ...
            <ul className="flex space-x-8">
              ...
              <li className="group relative">
                <Link href="/phases/idea">
                  <a className="text-slate-600 hover:text-primary font-medium">Business Lifecycle</a>
                </Link>
                <div className="absolute left-0 top-full mt-1 w-48 bg-white shadow-lg rounded-md py-2 hidden group-hover:block">
                  <Link href="/phases/idea">
                    <a className="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-primary">Idea Phase</a>
                  </Link>
                  <Link href="/phases/build">
                    <a className="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-primary">Build Phase</a>
                  </Link>
                  <Link href="/phases/grow">
                    <a className="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-primary">Grow Phase</a>
                  </Link>
                  <Link href="/phases/manage">
                    <a className="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-primary">Manage Phase</a>
                  </Link>
                </div>
              </li>
              <li>
                <Link href="/storage">
                  <a className="text-slate-600 hover:text-primary font-medium">Documents</a>
                </Link>
              </li>
              <li>
                <Link href="/resources">
